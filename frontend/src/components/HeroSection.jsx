        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-2 bg-gray-800/50 border border-gray-700 rounded-full px-4 py-2">
              ...
              <span className="text-gray-300 text-sm">Human-Powered Verification</span>
            </div>
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-xl leading-relaxed">
              The first live verification protocol. Real people, real locations, real-time proof. Stop scams before they happen.
            </p>
